...
PREFIX = 'nantic'
MODULE2PREFIX = {'account_bank_statement_account': 'trytonspain'}
OWNER = {
    'nantic':'NaN-tic',
    'trytonzz':'nanticzz',
}
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:NaN-tic/trytond-account_bank_statement_rule',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_bank_statement_rule'
    },
    classifiers=[
